...
<div class="search-filters">
    ...
    <?= $form->field($model, 'tag')->dropDownList(SimpleArrayHelper::map(Gallery::getTagList()), ['prompt' => Yii::t('backend', 'Prompt.All.Female')]) ?>
    ...
    <?= $form->field($model, 'status')->dropDownList(SimpleArrayHelper::map(Gallery::getStatusList()), ['prompt' => Yii::t('backend', 'Prompt.All.Male')]) ?>
